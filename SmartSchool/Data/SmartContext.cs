		...
		protected override void OnModelCreating(ModelBuilder builder)
		{
            ...
            builder.Entity<Professor>()
                .HasData(new List<Professor>(){
                    new Professor(1, "Lauro", 1, "Oliveira"),
                    new Professor(2, "Roberto", 2, "Soares"),
                    new Professor(3, "Ronaldo", 3, "Marconi"),
                    new Professor(4, "Rodrigo", 4, "Carvalho"),
                    new Professor(5, "Alexandre", 5, "Montanha"),
                });
